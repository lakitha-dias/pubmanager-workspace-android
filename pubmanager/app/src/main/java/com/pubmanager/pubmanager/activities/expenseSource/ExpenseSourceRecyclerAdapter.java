...
public class ExpenseSourceRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<ExpenseSourceRecyclerEntity> list;
    Context context;
    private final int SHOW_MENU = 1;
    private final int HIDE_MENU = 2;

    public ExpenseSourceRecyclerAdapter(Context context, List<ExpenseSourceRecyclerEntity> articlesList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ExpenseSourceRecyclerEntity entity = list.get(position);
