...
public class ActivityHomeBindingImpl extends ActivityHomeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.bg_top_header, 1);
        sViewsWithIds.put(R.id.user_photo, 2);
        sViewsWithIds.put(R.id.user_name, 3);
        sViewsWithIds.put(R.id.user_id, 4);
        sViewsWithIds.put(R.id.categoriesCard, 5);
        sViewsWithIds.put(R.id.userAnalytics, 6);
        sViewsWithIds.put(R.id.expensesCard, 7);
        sViewsWithIds.put(R.id.categoryExpenses, 8);
    }
    // views
    @NonNull
